...
function createDependencyTable(rows) {
...
function toDependencyTable({ from: fromDeps, to: toDeps, ownersChangedDeps, format, }) {
    const table = createDependencyTable(Object.keys(toDeps).map(dep => {
 ...
 * @param options
 */
function printUpgradesTable({ current, upgraded, ownersChangedDeps, }, options) {
    var _a;
    ...
    if ((_a = options.format) === null || _a === void 0 ? void 0 : _a.includes('group')) {
        const groups = (0, keyValueBy_1.default)(upgraded, (dep, to, accum) => {
        ...
        if (groups.patch) {
            ...
            print(options, toDependencyTable({
                from: current,
                to: groups.patch,
                ownersChangedDeps,
 ...
 */
function printUpgrades(options, { current, latest, upgraded, total, ownersChangedDeps, errors, }) {
    var _a;
    const chalk = options.color ? new chalk_1.default.Instance({ level: 1 }) : chalk_1.default;
    if (!((_a = options.format) === null || _a === void 0 ? void 0 : _a.includes('group'))) {
        print(options, '');
...
function printIgnoredUpdates(options, ignoredUpdates) {
    ...
    const table = createDependencyTable(Object.entries(ignoredUpdates).map(([pkgName, { from, to, reason }]) => {
